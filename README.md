...
Components for fetching external timetable and realtime information from non compliant sources (non Netex/GTFS nor SIRI)
...
* Local run: `java -Xmx1280m -jar target/extime-0.0.1-SNAPSHOT.jar`
