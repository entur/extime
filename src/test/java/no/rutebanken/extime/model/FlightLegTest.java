...
import static no.rutebanken.extime.TestUtils.createFlightLeg;

class FlightLegTest {

    @Test
    void testIsNextLeg() {
        FlightLeg flight1 = createFlightLeg(1L, "WF", "149", "OSL",
                ZonedDateTime.parse("2017-01-01T06:55:00Z"), "HOV", ZonedDateTime.parse("2017-01-01T07:30:00Z"));

        FlightLeg flight2 = createFlightLeg(2L, "WF", "149", "HOV",
    ...
    void testMatchNextIata() {
        FlightLeg flight1 = createFlightLeg(1L, "SK", "4455", "TRD",
    ...
    void testDoNotMatchNextIata() {
        FlightLeg flight1 = createFlightLeg(2L, "SK", "4455", "BGO",
                ZonedDateTime.parse("2017-01-01T08:00:00Z"), "TRD", ZonedDateTime.parse("2017-01-01T08:30:00Z"));
        FlightLeg flight2 = createFlightLeg(1L, "SK", "4455", "OSL",
                ZonedDateTime.parse("2017-01-01T09:00:00Z"), "TRD", ZonedDateTime.parse("2017-01-01T09:30:00Z"));
